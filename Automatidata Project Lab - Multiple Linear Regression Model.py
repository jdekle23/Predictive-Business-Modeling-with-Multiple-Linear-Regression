...
# 
# **We will find the answers to those questions later in the notebook.**
...
# Identify the range, shape, and central tendencies (mean, median, mode) of each variable.
# Spot skewness or kurtosis that may require transformation (e.g., log or square root).
# 
# **2. Detect and Handle Missing Values**
# Missing data can distort relationships.
# EDA helps you choose between imputation, removal, or flagging missing values.
# 
# **3. Identify Outliers**
# Outliers can overly influence the regression line and skew your coefficients.
# EDA helps you decide whether to transform, cap, or remove outliers.
# 
# **4. Explore Relationships Between Variables**
# Scatterplots and correlation matrices reveal how each independent variable relates to the dependent variable.
# Helps confirm linearity—a key assumption of linear regression.
# 
# **5. Detect Multicollinearity**
# Strong correlation between two or more predictors can destabilize your model.
# EDA highlights multicollinearity via correlation heatmaps or VIF (Variance Inflation Factor) checks.
# 
# **6. Validate Assumptions**
# Visuals like residual plots or Q-Q plots can help check linearity, normality, and homoscedasticity.
# You might discover the need for feature engineering or variable transformation.
# 
# **7. Feature Selection and Engineering**
# EDA shows you which features hold meaningful patterns and which might be noise.
# May lead to creating new interaction terms or polynomial features to enhance your model.
# 
# **8. Guide Model Strategy**
# After EDA, you’ll have a clearer idea of what preprocessing, transformations, or techniques (e.g., regularization or scaling) are needed.
